            ...
            <li>
                <div class="listing-main">
                    <div class="title">
                        ...
                        <div style="color:#3b4348 ;cursor: pointer;font-weight: bold;">
                            <!--<font style="vertical-align: inherit;">-->
                                <Button style="vertical-align: inherit;" @click="article">{{ this.article_title }}</Button>
                            <!--</font>-->
                        </div>
                    </div>
                    ...
                    <div class="list-author" style="margin-top: 10px;padding: 4px 3px 4px 0px;border-top:1px solid rgb(227, 227, 227);border-bottom: 1px solid rgb(227, 227, 227);margin-bottom: 15px;font-size: 12px;">
                        <span class="list"><Icon type="ios-calendar" />2019年2月13日</span>
                        <span class="list"><Icon type="ios-contact" /><a :href=" '#/user' ">莉莎</a></span>
                        <span class="list"><Icon type="ios-chatboxes" />13<span>评论</span></span>
...
//                console.log(this.article_title)
                this.$router.push({name:'article_one', params: {article_title:this.article_title,article_body: this.article_body}})
            },
            edit(){
